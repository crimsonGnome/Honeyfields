...
//make sure frontend Reflects with backend
...
class UserPermissions extends React.Component {
  ...
  handlePermissionChnage = (e, updatePermissions) => {
                ...
                <td key={permission}>
                  <label htmlFor={`${user.id}-permission-${permission}`}>
                    <input
                      ...
                      value={permission}
                      onChange={e =>
                        this.handlePermissionChnage(e, updatePermissions)
                      }
                    />
                  </label>
                </td>
